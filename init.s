...
.LFB1:
	...
	popq	%rax
	.cfi_def_cfa_offset 8
	.stabn	68,0,32,.LM32-.LFBB2
.LM32:
	leaq	edata(%rip), %rdi
	.stabn	68,0,32,.LM33-.LFBB2
.LM33:
	leaq	end(%rip), %rdx
	xorl	%esi, %esi
	subl	%edi, %edx
...
.LM34:
	subq	$8, %rsp
	.cfi_def_cfa_offset 16
	.stabn	68,0,32,.LM35-.LFBB2
.LM35:
	call	memset@PLT
	.stabn	68,0,36,.LM36-.LFBB2
.LM36:
	call	cons_init@PLT
	.stabn	68,0,38,.LM37-.LFBB2
.LM37:
	leaq	.LC2(%rip), %rdi
	movl	$6828, %esi
	xorl	%eax, %eax
...
.LM42:
	...
	.p2align 3
.L20:
	.stabn	68,0,80,.LM43-.LFBB3
.LM43:
	xorl	%edi, %edi
	call	monitor@PLT
	jmp	.L20
.L23:
	.stabn	68,0,66,.LM44-.LFBB3
.LM44:
...
# 69 "kern/init.c" 1
	cli; cld
# 0 "" 2
	.stabn	68,0,71,.LM46-.LFBB3
.LM46:
#NO_APP
	leaq	224(%rsp), %rax
	.stabn	68,0,72,.LM47-.LFBB3
.LM47:
	movl	%esi, %edx
	movq	%rdi, %rsi
	.stabn	68,0,71,.LM48-.LFBB3
.LM48:
	movl	$24, (%rsp)
	movq	%rax, 8(%rsp)
	leaq	32(%rsp), %rax
	.stabn	68,0,72,.LM49-.LFBB3
.LM49:
	leaq	.LC3(%rip), %rdi
	.stabn	68,0,71,.LM50-.LFBB3
.LM50:
	movq	%rax, 16(%rsp)
	.stabn	68,0,72,.LM51-.LFBB3
.LM51:
	xorl	%eax, %eax
	.stabn	68,0,71,.LM52-.LFBB3
.LM52:
	movl	$48, 4(%rsp)
	.stabn	68,0,72,.LM53-.LFBB3
.LM53:
	call	cprintf@PLT
	.stabn	68,0,73,.LM54-.LFBB3
.LM54:
	movq	%rbp, %rdi
	movq	%rsp, %rsi
	call	vcprintf@PLT
	.stabn	68,0,74,.LM55-.LFBB3
.LM55:
	leaq	.LC4(%rip), %rdi
	xorl	%eax, %eax
	call	cprintf@PLT
...
.LM65:
	call	cprintf@PLT
	.stabn	68,0,91,.LM66-.LFBB4
.LM66:
	movq	%rbp, %rdi
	movq	%rsp, %rsi
	call	vcprintf@PLT
	.stabn	68,0,92,.LM67-.LFBB4
.LM67:
	xorl	%eax, %eax
	leaq	.LC4(%rip), %rdi
	call	cprintf@PLT
	.stabn	68,0,94,.LM68-.LFBB4
.LM68:
	movq	24(%rsp), %rax
	subq	%fs:40, %rax
	jne	.L28
